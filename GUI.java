...
public class GUI extends JFrame {
    ...
    private void initComponents() {
        ...
        LogoIcon = new ImageIcon(getClass().getResource("/media/logo.png"));
        // resize logo
        ...
        statisIcon = new ImageIcon(getClass().getResource("/media/statistics.png"));
    ...
    private void btnFindPerformed(ActionEvent e) {
        ...
        } else {// trường hợp tìm không thấy
    ...
    private void showEmptyScreen(JPanel emptyScreen) {
    ...
    private void showSingleWordScreen(Word w, JPanel singleWordScreen) {
        // set elements
        markIcon = new ImageIcon(getClass().getResource("/media/mark.png"));
        unmarkIcon = new ImageIcon(getClass().getResource("/media/unmark.png"));
        deleteIcon = new ImageIcon(getClass().getResource("/media/bin.png"));
        btnDelete = new JButton();

        singleWordScreen.removeAll(); // xóa thông tin từ tìm kiếm phía trước

        // resize cho hình ảnh(button) mark
        origin = markIcon.getImage();
        resize = origin.getScaledInstance(30, 30, Image.SCALE_SMOOTH);
        markIcon = new ImageIcon(resize);

        // resize cho hình ảnh(button) unmark
        origin = unmarkIcon.getImage();
        resize = origin.getScaledInstance(30, 30, Image.SCALE_SMOOTH);
        unmarkIcon = new ImageIcon(resize);

        // resize cho hình ảnh(button) delete
    ...
    private void showStatisticScreen(JPanel statisticScreen, String from, String to) {
        // set layout
    ...
    private void btnMarkPerformed(ActionEvent e) {
        ...
        // resize cho button mark
        origin = markIcon.getImage();
        resize = origin.getScaledInstance(30, 30, Image.SCALE_SMOOTH);
        markIcon = new ImageIcon(resize);

        // resize cho button unmark
        origin = unmarkIcon.getImage();
        resize = origin.getScaledInstance(30, 30, Image.SCALE_SMOOTH);
        unmarkIcon = new ImageIcon(resize);
        if (checkMark == false) {
    ...
    class MeaningRenderer extends JPanel implements ListCellRenderer<Mean> {
        private ImageIcon icon = new ImageIcon(getClass().getResource("/media/bookmark.png"));
